"""Legacy RGB-only collector retained for comparison with the depth variants."""
...
def main() -> int:
    ...
    try:
        ...
        started = True
        print("This legacy script is RGB-only; it does not calculate rotation.")
